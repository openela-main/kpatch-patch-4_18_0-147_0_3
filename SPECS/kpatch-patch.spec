...
%define kernel_ver	4.18.0-147.0.3.el8_1
...
%changelog
* Tue Nov 12 2019 Yannick Cote <ycote@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-147.0.3.el8_1 [1771250]
